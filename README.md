...
The weights file best.pt is around 150 MB, which is over the GitHub file limit, so it is not in this repository. Download it from [WEIGHTS LINK] and put it at exports/fire_detection_final/best.pt.
